...
format:
	...
	@shfmt -w -i 2 -ci $(shell find . -name "*.sh" -o -name "*.bats" -o -name "functions" -o -name "config" -o -name "commands" -o -name "install" -o -name "post-*" -o -name "pre-*" | grep -v './tmp/' | grep -v './.git/')

format-check:
	@echo "Checking shell file formatting with shfmt..."
	@if ! shfmt -d -i 2 -ci $(shell find . -name "*.sh" -o -name "*.bats" -o -name "functions" -o -name "config" -o -name "commands" -o -name "install" -o -name "post-*" -o -name "pre-*" | grep -v './tmp/' | grep -v './.git/'); then \
